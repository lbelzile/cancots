...
There will be a session in English and one in French (if demand is sufficient).
...
Hotels nearby include the following
...
Un atelier dédié aux enseignant(e) du collégial se déroulera le mardi 10 juin, visant particulièrement le cours de Probabilité et statistique du programme préuniversitaire de sciences de la nature et sciences, lettres et arts. La journée débutera avec deux heures de présentations. Les participant(e)s seront ensuite amené(e)s à travailler en petits groupes sur des livrables pour ramener chez eux du matériel de cours. Les exemples incluent
...
Notez qu'il y aura une séance en français et une en anglais si la demande est suffisante.
...
Les dîners et pauses-café sont incluses avec l'inscription.
...
Les hôtels et autres hébergements à proximité incluent notamment:
