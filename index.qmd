...
[Opening remarks](files/CanCOTS_opening_remarks.pdf)
...
1. Designing a modern master program in statistics or data science ([Wesley Burr](http://www.wesleyburr.com/pages/about.html), [Lisa Lix](https://home.cc.umanitoba.ca/~lixlm/)) - A.547 Laurent-Ferreira
2. Interactive **R** tutorials for learning and assessments ([Russell Steele](https://www.mcgill.ca/mathstat/russell-steele), David Riegert and [Léo Belzile](https://lbelzile.bitbucket.io)) - A.536 MNP
3. Evidence-based teaching for learning in statistics education ([Asal Asleman](https://www.utm.utoronto.ca/math-cs-stats/people/asal-aslemand)) - A.545 Denis-Girouard
4. Teaching advanced analytical topics in biostatistics courses ([Kuan Liu](https://www.kuan-liu.com/)) - A.563 Chongqing
5. Incorporating artificial intelligence and ethics in statistics curriculum ([Anne-Sophie Charest](https://anne-sophie-charest.fsg.ulaval.ca/)) - C.530 Telesystem
6. Incorporating causal inference in statistics courses ([G. Alexi Rodríguez-Arelis](https://alexrod.netlify.app/)) - A.579 CTI Capital

Access to the Google Drive: [`bit.ly/cancots`](bit.ly/cancots)
...
- 18:30-20:30 - Diner [Le 409](https://le409.ca/)
...
1. Concevoir un programme moderne de maîtrise en statistique et science des données ([Wesley Burr](http://www.wesleyburr.com/pages/about.html), [Lisa Lix](https://home.cc.umanitoba.ca/~lixlm/)) - A.547 Laurent-Ferreira
2. Tutoriels et formulaires interactifs avec **R** pour l'apprentissage de la programmation et les évaluations ([Russell Steele](https://www.mcgill.ca/mathstat/russell-steele), David Riegert et [Léo Belzile](https://lbelzile.bitbucket.io)) - A.536 MNP
3. Enseignement fondé sur les preuves pour l'apprentissage de concepts statistiques ([Asal Asleman](https://www.utm.utoronto.ca/math-cs-stats/people/asal-aslemand))  - A.545 Denis-Girouard
4. Enseignement de concepts analytiques avancés en biostatistique ([Kuan Liu](https://www.kuan-liu.com/)) - A.563 Chongqing
5. Incorporer l'intelligence artificielle et l'éthique au sein du cursus ([Anne-Sophie Charest](https://anne-sophie-charest.fsg.ulaval.ca/)) - C.530 Telesystem
6. Ajout de concepts d'inférence causale aux cours de statistique ([G. Alexi Rodríguez-Arelis](https://alexrod.netlify.app/)) - A.579 CTI Capital

Accès au Google Drive: [`bit.ly/cancots`](bit.ly/cancots)
...
- 12h00-13h30 - Pause dîner (salle D.726)
