...
There will be a session in English and one in French (if demand is sufficient). [Sign up  using this form](https://forms.gle/nZQih98FvTRGKvf26) to get notified when registration opens.
...
Notez qu'il y aura une séance en français et une en anglais si la demande est suffisante.  [Inscrivez-vous via ce formulaire](https://forms.gle/nZQih98FvTRGKvf26) pour nous signifier votre intérêt et recevoir un message lorsque l'inscription ouvrira.
...
Les dîners et pauses-café sont inclus avec l'inscription.

# Soutien financier

Nous réservons 4000$ pour soutenir financièrement des participant(e)s grâce à la contribution financière de l'INCASS et du CRM. Ce financement sera attribué selon les besoins, en priorisant les étudiant(e)s des cycles supérieurs et les chercheurs et chercheuses en début de carrière sans soutien des organismes subventionnaires. Les participant(e)s pourront solliciter du soutien via le formulaire d'inscription; ce dernier sera alloué par le comité scientifique et distribué sous forme de remboursement à la fin du congrès.
