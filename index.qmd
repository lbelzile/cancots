...
3. Universal design and Evidence-based teaching for learning in statistics education ([Nathalie Moon](https://www.statistics.utoronto.ca/people/directories/all-faculty/nathalie-moon), [Asal Asleman](https://www.utm.utoronto.ca/math-cs-stats/people/asal-aslemand))
...
- Explore methods to make statistical learning more inclusive for students with diverse learning needs, backgrounds, interests, and goals 
- Share techniques for creating adaptable learning materials and assessment strategies which are aligned with course learning objectives and consider generative AI

**Deliverables**:

- Creating a library of course-level learning objectives for various statistics courses (depending on participants' interests and experience), along with a banks of proposed assessment types/formats and learning activities to align with these objectives.
...
3. Devis universels et enseignement fondé sur les preuves pour l'apprentissage de concepts statistiques ([Nathalie Moon](https://www.statistics.utoronto.ca/people/directories/all-faculty/nathalie-moon) et [Asal Asleman](https://www.utm.utoronto.ca/math-cs-stats/people/asal-aslemand))
